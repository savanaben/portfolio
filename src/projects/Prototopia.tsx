...
<Container
  ...
  leftContent={
      ...
      <Paragraph>
        Drag and drop is <Link href={`https://www.w3.org/TR/WCAG22/#dragging-movements`}>officially</Link> not accessible anymore. You need an &quot;single pointer&quot; alternative to all drag actions (not just keyboard support!). 
      </Paragraph>
      <Paragraph>
...
<Container
  ...
  leftContent={
      ...
      <Paragraph>
        This project leaned on some great research (<Link href={`https://blog.duolingo.com/new-duolingo-home-screen-design/`}>1</Link>, <Link href={`https://blog.duolingo.com/how-duolingo-streak-builds-habit/`}>2</Link>, <Link href={`https://www.lennysnewsletter.com/p/how-duolingo-reignited-user-growth`}>3</Link>) by the Duolingo team on various gamification and other methods to helping people perserve. 
      </Paragraph>
...
<Container
  ...
  leftContent={
      <>
      <Heading color="#494f67" alignment="left" level={3}>Converting a platform to responsive</Heading>
      <Heading color="#494f67" alignment="left" level={5}>svelte</Heading>
      <Paragraph>
        Drag and drop is officially not accessible anymore. You need an &quot;single pointer&quot; alternative to all drag actions (not just keyboard support!). 
      </Paragraph>
      <Paragraph>
        This project revamped the NAEP assessments match/drag-and-drop question type, bringing click-and-click support. You simply click on a drag object, then click where you want it to go. Ironically my prototype does not actually support click-click, but it was instrumental in testing various state, style, and keyboard navigation updates and easing spec handoff to developers. 
      </Paragraph>
